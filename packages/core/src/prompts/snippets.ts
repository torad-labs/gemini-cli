...
export function renderPreamble(options?: PreambleOptions): string {
  ...
  return options.interactive
    ? 'You are torad-code, an interactive CLI agent specializing in software engineering tasks. Your primary goal is to help users safely and effectively.'
    : 'You are torad-code, an autonomous CLI agent specializing in software engineering tasks. Your primary goal is to help users safely and effectively.';
}
