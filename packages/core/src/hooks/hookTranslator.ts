...
/**
 * Decoupled LLM request format - stable across torad-code versions
 */
...
/**
 * Decoupled LLM response format - stable across torad-code versions
 */
...
/**
 * Decoupled tool configuration - stable across torad-code versions
 */
