...
1.  Link this extension to your local torad-code installation:

    ```bash
    gemini extensions link packages/cli/src/commands/extensions/examples/policies
    ```

2.  Restart your torad-code session.
...
For security, torad-code ignores any `allow` decisions or `yolo` mode
